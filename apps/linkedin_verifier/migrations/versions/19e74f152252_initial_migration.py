...
Revision ID: 19e74f152252
Revises: 
Create Date: 2025-01-17 11:57:15.454105
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "provider_type",
            sa.Enum("SCRAPIN", "TOMQUIRK", name="linkedinprovidertype"),
            nullable=False,
        ),
    ...
    op.create_index(
        op.f("ix_linkedin_api_limits_provider_type"),
        "linkedin_api_limits",
        ["provider_type"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["profile_id"],
            ["linkedin_test.linkedin_profiles.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
        schema="linkedin_test",
    )
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table("linkedin_experience", schema="linkedin_test")
    op.drop_table("linkedin_education", schema="linkedin_test")
    op.drop_index(
        "ix_users_telegram_id", table_name="users", schema="linkedin_test"
    )
    op.drop_table("users", schema="linkedin_test")
    op.drop_table("linkedin_profiles", schema="linkedin_test")
    op.drop_index(
        op.f("ix_linkedin_api_limits_provider_type"),
        table_name="linkedin_api_limits",
    )
    op.drop_index("idx_provider_unique", table_name="linkedin_api_limits")
    op.drop_index("idx_limits_status", table_name="linkedin_api_limits")
    op.drop_table("linkedin_api_limits")
    # ### end Alembic commands ###

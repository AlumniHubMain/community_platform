    ...
    async with db.session() as session:
        ...
        linkedin_profiles = [
            ORMLinkedInProfile(
                ...
                experience=[{"company": "Tech Corp", "title": "Senior Software Engineer", "duration": "2020-present"}],
                education=[{"school": "University of London", "degree": "Computer Science", "year": "2015-2019"}],
            ...
            ORMLinkedInProfile(
                ...
                experience=[{"company": "Product Co", "title": "Product Manager", "duration": "2019-present"}],
                education=[
                    {"school": "Moscow State University", "degree": "Business Administration", "year": "2014-2018"}
                ],

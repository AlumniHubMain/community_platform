...
admitted_people: dict[int,
                      Staff] = {347684159: Staff(telegram_id=347684159,
...
notified_people: list[int] = [
    i for i in admitted_people if admitted_people[i].is_notified is True]

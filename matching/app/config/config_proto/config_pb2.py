...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_SERVICECONFIG']._serialized_end=212
  _globals['_CONFIG']._serialized_start=215
  _globals['_CONFIG']._serialized_end=366

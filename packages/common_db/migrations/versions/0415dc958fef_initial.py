...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("attendees", sa.String(), nullable=False),
        sa.Column("join_url", sa.String(), nullable=False),
        sa.Column("callbot_id", sa.String(), nullable=True),
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
        sa.Column(
            "created_at",
            sa.DateTime(),
    ...
    op.create_index(
        "ix_callbot_meetings_start_time",
        "callbot_meetings",
        ["start_time"],
        unique=False,
        schema=f"{schema}",
    ...
    op.create_index(
        "ix_callbot_enabled_users_email",
        "callbot_enabled_users",
        ["email"],
        unique=True,
        schema=f"{schema}",
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index("ix_callbot_meetings_google_id", table_name="callbot_meetings", schema=f'{schema}')
    op.drop_index("ix_callbot_meetings_start_time", table_name="callbot_meetings", schema=f'{schema}')
    op.drop_index("ix_callbot_meetings_end_time", table_name="callbot_meetings", schema=f'{schema}')
    op.drop_index("ix_callbot_enabled_users_email", table_name="callbot_enabled_users", schema=f"{schema}")
    op.drop_table("callbot_meetings", schema=f'{schema}')
    op.drop_table("callbot_enabled_users", schema=f'{schema}')
